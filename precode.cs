...
namespace Numberics
{
    class MainClass
    {
            ...
            switch (key)
            {
                ...
                case 5:
                    ...
                    if (k <= N)
                    {
                        ...
                        Console.WriteLine("Đạo hàm cấp {0} tại {1} = " + a[N - k] * Giaithua(k), k, c);
                    }
                    else
                    {
        ...
        public static void BPTT()
        {
            ...
            double[] x = new double[N];
            double[] y =  { 1, 0.97350, 0.95135, 0.93304, 0.91817, 0.90640, 0.89747, 0.89115, 0.88726, 0.88565,0.88623,0.88887,0.89352,0.90012,0.90864,0.91906,0.93138,0.94561,0.96177,0.97988,1};
        ...
        public static void RK2()
        {
            ...
            Console.WriteLine("Nhập x0");
            double x = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("Nhập y_0 (y(" + x + ")=y_0)");
            double y = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("Nhập h");
            double h = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine("Nhập x_N");
            double xN = Convert.ToDouble(Console.ReadLine());
            int N = Convert.ToInt16((xN - x) / h);
            Console.WriteLine("Nhập a_2 (0 < a_2 <= 1) ");
            int lap = 0;
        back:
